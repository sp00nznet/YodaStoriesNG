...
public static class Palette
{
    ...
    /// <summary>
    /// Loads a fallback palette if DAW palette is not available.
    /// </summary>
    private static void LoadFallbackPalette()
    {
        // Use the standard Desktop Adventures palette as fallback
        uint[] fallback = new uint[256]
        {
            // Row 0 (0x00-0x0F)
        ...
        Array.Copy(fallback, OriginalColors, 256);
        Array.Copy(fallback, Colors, 256);
        _isLoaded = true;
    }
